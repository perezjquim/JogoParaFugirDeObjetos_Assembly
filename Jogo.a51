...
ImagemX EQU 41  						; Display com 7 valores
VidasRestantes EQU 42  			; Vidas restantes do jogador
TempoObstaculos EQU 43	 	; Tempo (restante) antes de descerem (novamente) os obstáculos
DificuldadeAtual EQU 44			; Dificuldade atual do jogo (tempo estipulado para a frequência com que os obstáculos vão descendo)
ObstaculosInicio EQU 45			; Limite superior dos obstáculos
NivelAtual EQU 46						; Nível atual do jogo (que representa a imagem do vetor a ser desenhada)
ImagemAtual EQU 47
LinhaAtiva EQU 48
;*******************************************************************************
...
CSEG AT 050h
Principal:
    MOV SP, #7			; Endereço inicial da stack pointer
    ...
    LigarInterrupcoes:
        ...
        MOV TL1, #TEMPO_T1; 
        MOV IP, #00000000b		; Não altera as prioridades
...
VerificarObstaculos:
    ...
    MOV TempoObstaculos, DificuldadeAtual		; Actualiza a variável tempo
...
;*******************************************************************************
GameOver:
    MOV R0, #IMAGEM_GAMEOVER
    CALL DesenharNovaImagem
    CALL DesligarInterrupcoes
    JMP EndLoop

Victory:
    MOV R0, #IMAGEM_VICTORY
    CALL DesenharNovaImagem
    CALL DesligarInterrupcoes
    JMP EndLoop
